...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" w-full flex text-white flex-wrap items-center justify-between py-3 bg-gray-900 shadow-lg navbar navbar-expand-lg fixed-top ">
        <div className="container-fluid w-full flex items-center justify-between px-6">
          <Link to="/" className="text-xl pr-2 font-semibold">
            MRTCMRL MOVİE
          </Link>
